...
class decompress_jpeg(nn.Module):
    ...
    """
    def __init__(self, height, width, rounding=torch.round, factor=1, split_dim=1):
    ...
    def forward(self, y_hat, shapes):
        y, cb, cr = torch.split(y_hat, shapes, dim=self.split_dim)
